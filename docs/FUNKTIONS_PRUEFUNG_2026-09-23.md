...
Zusatz Wetter Revision 4: `test_weather_assessment` prüft alle 18 Fragen auf 54 bewerteten und 39 freien Antwortwegen mit unabhängig festgehaltenen Lösungen, die zwei Feuchterechnungen, Aufgaben, Hochdruckerklärung und getrennte Papierlösung. Sechs weitere gezielte Suiten bestanden; [genauer Umfang und Quellen](PHYSIK_WETTER_FRAGEN.md). 284 Suiten vorhanden; dies ist kein neuer vollständiger Gesamtlauf.

Zusatz nach `5a9c125`: 14 gezielte Suiten zum [Physik-Lernweg](PHYSIK_LERNWEG.md) und sieben zum [Wärmelehre-Fragenabgleich](PHYSIK_WAERME_FRAGEN.md) bestanden. Neue Prüfungen: `test_physics_learning_guide` und `test_thermal_assessment`. 20 Kapitelrouten, drei Klassenfilter, erhaltene Stofflisten/Speicherung, 29 unabhängig gelöste Wärmefragen auf 87 bewerteten und 42 freien Antwortwegen. Aktuell 283 Suiten vorhanden; dieser Nachweis ist kein neuer vollständiger Gesamtlauf. Native Nachweise und inhaltliche Grenzen stehen in den verlinkten Berichten.
