...
23.09.2026, GitHub-Zwischenstand auf Nutzerwunsch: [Alle Physik-Wiederholungswege und überarbeitete Statikfragen](PHYSIK_WIEDERHOLUNG_STATIK.md). 406/406 bewertete Physikfragen mit Abschnittsziel, 17 Statikfragen auf Revision 5 und zehn ergänzte Erklärungskästen. Gezielte Funktions- und Browserprüfungen bestanden; abschließende Sichtung der zuletzt veränderten Druckseiten und neuer Gesamtlauf offen. Übersetzungen bleiben ausgesetzt, Gesamtauftrag offen.

23.09.2026, lokale Weiterarbeit nach dem bestätigten Push `0ddcb5e`: [Wiederholung nach dem Kapitelcheck](QUIZ_WIEDERHOLUNGSWEGE.md) um 28 ausdrücklich zugeordnete Abschlussfragen ergänzt. Alle 105 bewerteten Fragen der vierten Physikklasse führen zu einem Lernabschnitt; 350 native Tastaturwege geprüft. Der neue Audit benennt 214 noch fehlende Abschnittszuordnungen in den priorisierten Fächern, darunter 81 in älteren Physikkapiteln. Das ist der nächste konkrete Schritt; Übersetzungen ausgesetzt, Gesamtauftrag offen.

23.09.2026, weitere lokale Arbeit nach `5a9c125`: [Wetter Revision 4](PHYSIK_WETTER_FRAGEN.md) mit zehn verbesserten Fragen, einem Datenvergleich zur relativen Luftfeuchtigkeit und einer Hochdruck-/Nebel-Erklärung ergänzt. Alle 18 Fragen gelesen; 54 bewertete und 39 freie Antwortwege sowie sieben gezielte Suiten bestanden. 284 Suiten vorhanden, kein neuer Gesamtlauf. Nächster Qualitätsschritt: die übrigen Viertklassfragen und passende Abschnittsrücksprünge bei älteren Abschlussfragen. Neue Änderungen bleiben lokal, Übersetzungen ausgesetzt, Gesamtauftrag offen.

23.09.2026, Weiterarbeit nach dem bestätigten Push `5a9c125`: [Physikübersicht für die 2.–4. Klasse](PHYSIK_LERNWEG.md) mit allen 20 Kapitelzugängen, Vorwissen, Grundstoff-/Vertiefungshinweisen und drei Klassenfiltern ergänzt. 14 gezielte Suiten und 18 native Klassenwahlen in sechs Ansichten bestanden. Anschließend alle 29 [Wärmelehre-Fragen](PHYSIK_WAERME_FRAGEN.md) gelesen und 13 ältere Fragen überarbeitet; Revision 5, sieben gezielte Suiten mit 87 bewerteten und 42 freien Antwortwegen bestanden. 283 Suiten vorhanden, kein neuer Gesamtlauf. Nächster belegter Qualitätsschritt: ältere Wetterfragen und danach die übrigen Viertklassfragen. Übersetzungen ausgesetzt; neue Änderungen lokal, Gesamtauftrag offen. Frühere Angaben „noch nicht gepusht“ beziehen sich auf den damaligen Stand.

23.09.2026, weitere lokale Arbeit nach `a5918a6`: [Strahlung in Physik Klasse 4](PHYSIK_KLASSE4_ABGLEICH.md) um Signallabor, Quellenvergleich, LED-/IR-Untersuchung und fiktive UV-/Licht-/IR-Daten ergänzt. Sechs neue Fragen, zwei getrennte Papierlösungen; Revision 3 mit sieben Abschnitten. Native Prüfung: sechs Ansichten, 36 Modellzustände, 144 Deutungen und 36 neue Antwortwege; sechs betroffene Druckseiten gelesen. 14 gezielte Regressionen bestanden. 281 Suiten vorhanden, kein neuer Gesamtlauf; Inventar und Fragenaudit aktualisiert (2033 priorisierte Fragen). Nächster Schritt: zusammenhängender Physikabgleich von Reihenfolge, Voraussetzungen und Grundstoff/Vertiefung. Gesamtauftrag offen, Übersetzungen ausgesetzt, neue Änderungen noch nicht gepusht.

23.09.2026, Weiterarbeit nach `a5918a6`: [Physik Klasse 4](PHYSIK_KLASSE4_ABGLEICH.md) um Quellenarbeit zu aktuellen Klimazielen ergänzt: Wien, EU und Pariser Übereinkommen, fünf Aufgaben zu Belegen/Umsetzung, vier neue Fragen und getrennte Papierlösung. Wärmeversuche jetzt nativ in 18 Ansichten und auf acht betroffenen Druckseiten geprüft. Klimaziele: sechs Ansichten, 24 Antwortwege, Kontrast korrigiert, vier betroffene Druckseiten gelesen. 15 gezielte Regressionen nach Anpassung einer veralteten Fragenerwartung bestanden; 280 Suiten vorhanden, kein neuer Gesamtlauf. Inventar und Fragenaudit aktualisiert (2027 Fragen in den priorisierten Fächern). K7/K8 zu Strahlung und Gesamtauftrag bleiben offen. Übersetzungen ausgesetzt; neue Änderungen lokal, noch nicht gepusht.

GitHub-Zwischenstand auf Nutzerwunsch, 23.09.2026, nach `d13b006`: Physikabgleich der 3. Klasse, überarbeitetes Klimakapitel und drei eigene Wärmeversuche werden gesichert. Wärmelehre Revision 4 enthält kontrollierte Vergleiche zu Eis auf Unterlagen, hellen/dunklen Flächen und einer Farbwolke im Wasser, 13 Protokollzeilen, vier Vergleichslösungen und fünf zusätzliche Fragen (29 insgesamt). Vor diesem Zwischenstand bestanden acht gezielte Suiten: `test_thermal_inquiry`, `test_thermal_concepts`, `test_translation_revisions`, `test_clima_concepts`, `test_physics_year3`, `test_physics_worksheets`, `test_physics_guides`, `test_chapter_revisions`. Der Testaufruf für freie Antworten wurde mit dem richtigen Button-Kontext berichtigt. Inventar und Fragenaudit sind aktualisiert: 198 Kapitel, 2023 Fragen in den fünf priorisierten Fächern, keine strukturellen Auditbefunde. Die native Browserprüfung und die visuelle Druckprüfung der neuen Wärmeversuche bleiben offen; kein neuer vollständiger Gesamtlauf. Frühere Angaben „lokal“ bezeichnen den damaligen Stand. Übersetzungen bleiben ausgesetzt; der Gesamtauftrag ist nicht abgeschlossen.

23.09.2026: [Physikabgleich der 4. Klasse begonnen](PHYSIK_KLASSE4_ABGLEICH.md). Alle sechs Kapiteltexte und Arbeitsaufträge gelesen; konkrete Lücken bei Wärmeversuchen, aktuellen Klimaschutzzielen und Strahlungsvergleichen festgehalten. Klimakapitel Revision 2 ersetzt unbelegte Temperatur-/Prozentanzeigen durch drei qualitative Zustände, berichtigt Höhenklima und Archive und enthält zwölf Fragen mit plausiblen Optionen. Elf ergänzende Regressionen und die native Prüfung mit 18 Modellzuständen, 24 freien und 36 bewerteten Antworten bestanden; neue Druckseiten gesichtet. Jetzt 278 Suiten, kein neuer Gesamtlauf. Übersetzungen ausgesetzt; Gesamtauftrag offen, neue Änderungen nach `d13b006` lokal.

23.09.2026, Weiterarbeit nach `d13b006`: [Physik der 3. Klasse](PHYSIK_KLASSE3_ABGLEICH.md) mit allen 20 Lehrplananforderungen abgeglichen. Vier Kräfte-Stationen, Wiener Mobilitätsentscheidung und Bremsenergie-Recherche ergänzen die Lernhandlungen; Energie steht nun vor mechanischer Arbeit. Kondensator, Transformator und Drehimpuls bleiben getrennte Vertiefungen. 35 gezielte Regressionen bestanden; native Prüfungen zu neuen Aufgaben, Stromwirkungen und Induktion bestanden, ausgewählte neue Druckseiten gesichtet. Der frühere Gesamtnachweis über 276 Suiten liegt vor diesen Änderungen; kein neuer vollständiger 277er-Lauf behauptet. Inventar und Fragenaudit aktualisiert. Nächster Fachschritt: zusammenhängender Physikabgleich der 4. Klasse. Übersetzungen ausgesetzt; Gesamtauftrag offen, neue Änderungen lokal.

GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `ab3156e`: Grundstoff und Vertiefung der 2. Klasse sowie der begonnene Ausbau der 3. Klasse werden gesichert. Neu sind vier Kräfte-Stationen, ein Wiener Mobilitätsvergleich, Quellenarbeit zur Bremsenergie und eine stärker begriffsorientierte Kapitelreihenfolge. Kondensator, Transformator und Drehimpuls sind als Vertiefung gekennzeichnet; bestehende Lehrer-Stofflisten behalten ihre Reihenfolge. Drei gezielte Prüfungen wurden vor diesem Zwischenstand erneut erfolgreich ausgeführt: Physik Klasse 3, Grundstoff/Vertiefung und Lehrer-Stofflisten. Die native Funktionsprüfung der Klasse 3 bestand; eine leere mobile Bildschirmaufnahme muss wiederholt werden, die Sichtung der neuen Druckseiten und die abschließende Lehrplanzuordnung bleiben offen. Der frühere Nachweis über 276 Suiten liegt vor diesen jüngsten Änderungen; ein neuer vollständiger Gesamtlauf wird nicht behauptet. Inventar und Auditdateien bilden noch den davor dokumentierten Stand ab. Frühere Angaben „lokal“ beschreiben den damaligen Stand. Übersetzungen bleiben ausgesetzt; Physik, Mathematik, Chemie, Biologie und DGB haben Vorrang. Der Gesamtauftrag bleibt offen.
...
GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `f66005e`: Gesichert werden die ausgearbeiteten DGB-Kapitel Information und Kommunikation der 1. Klasse sowie der begonnene Ausbau von Produktion (Revision 4). Produktion umfasst nun den Vergleich derselben Umfragedaten als Text, Tabelle und Balkendiagramm sowie eine gemeinsame Präsentation; vorhandene Schleifen- und Umfragewerkstätten bleiben erhalten. Zehn gezielte Testsuiten wurden vor diesem Zwischenstand erneut erfolgreich ausgeführt (Quellenvergleich, Freigaben, Medienproduktion, Schleifen, Suchkompetenz, Transfer, Arbeitsblätter, vollständige Kapitelprüfungen, Inhaltsrevisionen und Sprachfallback). Die native Browserprüfung und vollständige Drucksichtung des jüngsten Produktionsstands sowie dessen abschließende Dokumentation bleiben offen. Der frühere Gesamtlauf mit 266 Suiten deckt diese späteren Änderungen nicht ab. Frühere Angaben „lokal“ beschreiben den damaligen Stand. Übersetzungen bleiben ausgesetzt; Physik, Mathematik, Chemie, Biologie und DGB behalten Vorrang. Der Gesamtauftrag bleibt offen.
...
GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `9233290`: Gesichert werden die überarbeitete DGB-Kommunikation der 2. Klasse sowie der aktuelle Ausbau von DGB-Produktion (Revision 3) mit eigener Programmierwerkstatt und Signalwerkstatt. Beide Werkstätten können bearbeitbare Arbeitsdateien zur Offline-Nutzung speichern; die Signalwerkstatt exportiert außerdem eine Ergebniskarte und eine WAV-Datei. Die fünf gezielten Testsuiten für Kommunikation, Paketwege, Punktezähler, Programmierwerkstatt und Signalwerkstatt wurden vor diesem Zwischenstand erneut erfolgreich ausgeführt. Die abschließende Sichtprüfung der jüngsten Produktions-Druckfassung, deren vollständige Dokumentation und der DGB-Jahrgangsabgleich bleiben offen. Der frühere Gesamtlauf mit 263 Suiten gilt nicht als Prüfung aller nachfolgenden Änderungen. Frühere Angaben „lokal“ beschreiben den damaligen Stand. Übersetzungen bleiben ausgesetzt; Physik, Mathematik, Chemie, Biologie und DGB behalten Vorrang. Der Gesamtauftrag ist weiterhin offen.
...
GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `c263c4c`: Gesichert werden [Arbeitsplatz und Beteiligung](DGB_ARBEITSPLATZ_BETEILIGUNG_KLASSE2.md) sowie [Dateien, Bits und Internetabruf](DGB_DATEIEN_BITS_INTERNET_KLASSE2.md) der 2. Klasse. Gezielte Funktions- und Browserprüfungen sowie der erneute vollständige Lauf mit 263/263 Suiten bestanden; siehe [Funktionsbericht](FUNKTIONS_PRUEFUNG_2026-09-23.md). Die letzten sieben Seiten der Information-Druckfassung und der vollständige DGB-Abgleich der 2. Klasse bleiben offen. Frühere Angaben „lokal“ beschreiben den damaligen Stand. Übersetzungen bleiben ausgesetzt; Physik, Mathematik, Chemie, Biologie und DGB behalten Vorrang. Der Gesamtauftrag bleibt offen.

Fortschritt 23.09.2026 nach `c263c4c`: [DGB-Handeln der 2. Klasse](DGB_ARBEITSPLATZ_BETEILIGUNG_KLASSE2.md) mit konkretem Geräte-/Supportfall, angeleitetem Netzwerk- und Dateiaustausch, zugänglicher Beteiligungsplanung und erprobbarer Nutzungsänderung ausgearbeitet. Acht Fälle, 18 Aufträge, acht bewertete Fragen und drei freie Übungen; Revision 1. 144 native Fallentscheidungen, alle 24 Quizantwortwege und sämtliche 19 endgültigen Druckseiten geprüft. Neue Änderungen lokal. Nächster belegter Inhaltsschritt: Dateigröße/binäre Struktur und Internetabruf in DGB-Information der 2. Klasse. Übersetzungen ausgesetzt; Gesamtauftrag offen.

GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `624b1e5`: Gesichert werden der zusammenhängende DGB-Abgleich der 3. Klasse, das überarbeitete Produktionskapitel und [Werkzeugwahl und faire Nutzung der 2. Klasse](DGB_WERKZEUGWAHL_KLASSE2.md). Die neue Orientierung enthält acht Fälle, 18 Aufträge, acht bewertete Fragen und drei freie Übungen, Revision 1. Gezielte Funktions-, Browser-, Calc- und Druckprüfungen bestanden. Der unten genannte Gesamtfunktionslauf mit 260 Suiten liegt vor dieser jüngsten Überarbeitung. Frühere Angaben „lokal“ beschreiben den damaligen Stand. Übersetzungen bleiben ausgesetzt; die fünf priorisierten Fächer und der Gesamtauftrag bleiben in Arbeit.

Gesamtprüfung 23.09.2026, 11:09 UTC: **260/260 vorhandene Funktionstestsuiten bestanden**. [Umfang und Grenzen des vollständigen Laufs](FUNKTIONS_PRUEFUNG_2026-09-23.md). Die nachfolgend beschriebenen lokalen Produktionsänderungen sind enthalten; kein neuer Push und keine vollständige Fach-/Produktabnahme.

Fortschritt 23.09.2026 nach `624b1e5`: Die [fünf DGB-Kapitel der 3. Klasse](DGB_KLASSE3_ABGLEICH.md) sind jetzt gemeinsam den 31 Kompetenzanforderungen und Anwendungsbereichen zugeordnet. Produktion besitzt einen klareren Lernweg, passend zugeordnete Fragen, drei verbesserte freie Übungen und einen Reserveauftrag zum Übertragen. Alle 39 bewerteten Antwortwege sowie native Abschnittswiederholung geprüft, sämtliche 27 Druckseiten gesichtet; Kartenumbruch und dunkle Überschriften verbessert. Revision 4 bleibt bestehen, weil alle bewerteten Fragen unverändert sind. Die Änderungen sind lokal. Nächster konkreter Inhaltsschritt: Orientierung der 2. Klasse; Übersetzungen ausgesetzt, Gesamtauftrag offen.

GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `d862b2b`: Gesichert werden die erweiterten DGB-Kapitel [Information](DGB_INFORMATION_KLASSE3.md) und [Kommunikation](DGB_KOMMUNIKATION_KLASSE3.md) der 3. Klasse, ihre Prüfungen sowie die abgeschlossene Drucksichtung von Orientierung. Frühere Angaben „lokal“ beschreiben den damaligen Stand. Die dokumentierten Teilprüfungen sind bestanden; eine vollständige fachliche und visuelle Gesamtabnahme bleibt offen. Übersetzungen bleiben ausgesetzt; Physik, Mathematik, Chemie, Biologie und DGB haben Vorrang.

Fortschritt 23.09.2026 nach `d862b2b`: DGB-Information der 3. Klasse verbindet die bestehende Achsenwerkstatt jetzt mit vier Quellenkarten, zwei offengelegten Suchlisten und einem überprüfbaren Prognosevergleich. Sechs Fallübungen, 18 Arbeitsaufträge, acht bewertete Fragen und drei freie Übungen; Revision 2. 108 native Fallentscheidungen, alle 24 Quizantwortwege, mobile Diagrammbedienung und sämtliche 17 endgültigen Druckseiten im dokumentierten Umfang geprüft. [Lehrplanzuordnung, Quellen und Nachweise](DGB_INFORMATION_KLASSE3.md). Nächster Bereich: zusammenhängender aktueller Abgleich der fünf DGB-Kapitel der 3. Klasse. Neue Änderungen bleiben lokal; Übersetzungen ausgesetzt, vollständiger Gesamtauftrag offen.

Fortschritt 23.09.2026 nach `d862b2b`: DGB-Kommunikation der 3. Klasse enthält sechs interaktive Fälle, 15 konkrete Aufträge und ein angeleitetes Teamprojekt mit Ausgangsmaterial, passenden Freigaben und überprüfter Überarbeitung. Acht bewertete Fragen, drei freie Übungen, Revision 1; 108 native Browserentscheidungen, alle 24 Quizantwortwege und sämtliche 17 endgültigen Lösungsdruckseiten im dokumentierten Umfang geprüft. [Lehrplanzuordnung und Nachweise](DGB_KOMMUNIKATION_KLASSE3.md). Auch die offenen 14 Druckseiten und mobilen Darstellungen von Orientierung sind abschließend gesichtet. Nächster Bereich: aktueller vollständiger Abgleich von DGB-Information der 3. Klasse. Neue Änderungen lokal; Übersetzungen ausgesetzt, Gesamtauftrag offen.

GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `980c82e`: Gesichert werden die überarbeiteten DGB-Kapitel [Handeln](DGB_GERAETE_SCHUTZ_NACHHALTIGKEIT.md) und [Orientierung](DGB_ORIENTIERUNG_KLASSE3.md) der 3. Klasse sowie die abgeschlossene ergänzende Druckprüfung der Rechtsübungen der 4. Klasse. Orientierung enthält ein interaktives Empfehlungsmodell und konkrete Aufgaben zu KI, vernetzten Geräten und Barrierefreiheit. Die dokumentierten Funktions- und Browserprüfungen bestehen; die endgültige visuelle Druck- und mobile Sichtprüfung von Orientierung bleibt offen. Frühere Angaben „lokal“ beschreiben ihren damaligen Stand. Übersetzungen bleiben ausgesetzt; Physik, Mathematik, Chemie, Biologie und DGB haben Vorrang. Der Gesamtauftrag bleibt offen.

Fortschritt 23.09.2026 nach `980c82e`: DGB-Handeln der 3. Klasse vollständig überarbeitet: sechs Geräte-/Schutz-/Umweltfälle, 14 konkrete Aufträge, acht bewertete Fragen und drei Übungen, Revision 1. 108 Browserentscheidungen, alle 24 Kapitelantwortwege und sämtliche 17 endgültigen Lösungsdruckseiten geprüft. [Inhalte, Lehrplanzuordnung und Nachweise](DGB_GERAETE_SCHUTZ_NACHHALTIGKEIT.md). Auch die verbleibende Drucksichtung der Rechtsübungen der 4. Klasse und ihre Matrixfortschreibung sind abgeschlossen. Nächster Bereich: vollständiger Abgleich und konkrete Fallmaterialien für die übrigen DGB-Kapitel der 3. Klasse, besonders Orientierung und Kommunikation. Neue Änderungen lokal; Gesamtauftrag offen, Übersetzungen ausgesetzt.

GitHub-Zwischenstand 23.09.2026 auf Nutzerwunsch, nach `ceb183e`: Gesichert werden das [Medienprojekt der 4. Klasse](DGB_MEDIENPROJEKT.md) und die laufenden [Datenschutz-/Verbraucherrechtsergänzungen](DGB_DATENSCHUTZ_VERBRAUCHERRECHTE.md). Die neuen Rechtsfälle, alle 60 Antwortwege der beiden Kapitel und die mobilen Rechtekarten bestehen die dokumentierten Teilprüfungen. Die restliche Sichtprüfung der betroffenen Druckseiten und die abschließende Fortschreibung der Klassenmatrix bleiben offen. Frühere Angaben „lokal“ beziehen sich auf ihren damaligen Stand. Übersetzungen bleiben ausgesetzt; Priorität haben Physik, Mathematik, Chemie, Biologie und DGB. Der Gesamtauftrag bleibt offen.

Fortschritt 23.09.2026 nach `ceb183e`: DGB-Produktion der 4. Klasse enthält einen vollständigen Medienprojektauftrag mit Text-/Grafikmaterial, zwei gestaltbaren Plakaten, wieder bearbeitbarer Offline-Arbeitsdatei, Rollenplan und dokumentierter Überarbeitung. Revision 4, neun Fragen; 144 Browser-Gestaltungszustände und 27 Kapitelantwortwege bestanden, alle 17 Kapitel-Druckseiten und beide endgültigen Plakate gesichtet. [Inhalte und genaue Prüfgrenzen](DGB_MEDIENPROJEKT.md). Neue Änderungen bleiben lokal. Die gezielten Rechts-/Quellenprüfungen der Klassenmatrix und der Gesamtauftrag bleiben offen; Übersetzungen ausgesetzt.
...
Der vollständige Funktionslauf am 23.09.2026 bestand mit 252 von 252 Tests. Alle 198 deutschen Kapitel ließen sich im gemeinsamen Renderer laden; die erneute Browserprüfung der Lern- und Lehrer-/Empfängerwege bestand ebenfalls. Die jeweiligen Fach- und Druckprüfungen sind in den verlinkten Nachweisen abgegrenzt. Dies ist keine vollständige fachliche oder visuelle Gesamtabnahme. Übersetzungen bleiben ausgesetzt; Priorität haben Physik, Mathematik, Chemie, Biologie und DGB. Der Gesamtauftrag bleibt offen.
