# Mathematik 1. Klasse – konsolidierter Prüfstand

Grundlage: gespeicherter RIS-Lehrplantext vom 05.09.2026, Kompetenzbeschreibungen und ausgewählte Präzisierungen für die erste Klasse erneut gelesen. Keine erneute rechtliche Aktualitätsbestätigung. Die aktuelle Navigation ordnet zwölf Kapitel der 5. Schulstufe zu: elf math1_-Kapitel und math2_8_statistik. Der Dateipräfix ist kein verlässlicher Klassenfilter.
...
Die Tabelle ist ein Arbeitsbefund und keine vollständige Fachabnahme. Nicht erneut vollständig gelesene Kapitel sind ausdrücklich markiert. Automatisierte Tests prüfen nur ihre programmierten Fälle. Visuelle Darstellung, Geräteeinsatz, reale Konstruktionen und Unterrichtstauglichkeit sind damit nicht bestätigt.

## Nachtrag: Rechteckgrundlagen umgesetzt

math1_11_figuren_koerper/rechteck_messen (Revision 2) enthält jetzt Herleitungen für U und A, ein Einheitsquadratmodell für alle ganzzahligen Seiten 1–10 cm, Umkehraufgaben, maßstäblichen Raumplan und eine L-Fläche mit äußerem Rand. Fünf Konstruktions-/Rechenaufträge, drei neue Fragen. Modelltest und alle Antwortwege bestanden; 95 STEM-Arbeitsblätter enthalten das neue Abschnittsmaterial. Die frühere Rechteck-Lückenbeschreibung in der Tabelle ist damit für diese Inhalte überholt, nicht jedoch die offene praktische/visuelle Abnahme. Quaderkompetenzen bleiben noch offen.
