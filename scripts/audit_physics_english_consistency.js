...
const defaultScopedTopics = ['akustik', 'arbeit', 'astronomie', 'drehundstatik', 'elektrizitaet', 'elektromagnetismus', 'energie', 'farben', 'kraft_und_bewegung', 'linsen_spiegel', 'optik1', 'rechenbeispiele', 'sieinheiten', 'waermelehre'];
