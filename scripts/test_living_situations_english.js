...
(async()=>{
 ...
 dom.window.close();console.log('PASS: English living situations chapter: four case studies, eight equivalent questions, matching workshop and complete assessment.');
