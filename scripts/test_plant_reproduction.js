...
(async()=>{
 ...
 await w.renderTopic();assert.equal(d.querySelectorAll('.chapter-question').length,12,'Twelve distinct questions, rather than duplicated section questions');
 ...
 dom.window.close();console.log('PASS: 12 distinct questions, revision, five reproduction stages, missing/wrong/correct feedback, stale feedback clearing, retry and keyboard reset.');
